...
WORKDIR /tmp
RUN wget -q https://ghidra-sre.org/ghidra_9.2.3_PUBLIC_20210325.zip -O ghidra.zip && \
	echo '9019c78f8b38d68fd40908b040466974a370e26ba51b2aaeafc744171040f714 ghidra.zip' | sha256sum -c
